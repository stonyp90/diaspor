...
```bash
cd /tmp/stony-vdfs
git remote add origin git@github.com:stonyp90/stony-vdfs.git
...
git remote add codeberg git@codeberg.org:stonyp90/stony-vdfs.git
