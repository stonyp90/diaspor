...
artifacts produced by `stony-vdfs-index`. It is published in the v0.1.0-alpha.1
...
- The Rust type `stony_vdfs_index::sidecar::SidecarRecord` exists at the
...
- **Adding** an optional field is **not** a breaking change. Readers must
  ...
  [`crates/stony-vdfs-conformance/SPEC.md`](../../crates/stony-vdfs-conformance/SPEC.md#m6--sidecar-persistence-and-v10)).
...
once `stony-vdfs-index` exposes `serde` derives on `SidecarRecord` (M6
deliverable). Until then, treat the schema as the source of truth.

## See also

- [`crates/stony-vdfs-index/src/sidecar.rs`](../../crates/stony-vdfs-index/src/sidecar.rs)
...
- [`ROADMAP.md`](../../ROADMAP.md) M5 / M6 sections for the milestones that
  ...
  trip tested in CI."
- [`crates/stony-vdfs-conformance/SPEC.md`](../../crates/stony-vdfs-conformance/SPEC.md)
