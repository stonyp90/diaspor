...
//!
//! ```text
//! cairn list <backend> <vfs-path>
//! cairn cat  <backend> <vfs-path>
//! cairn put  <backend> <vfs-path> < input.bin
//! ```
//!
//! Backends:
...
use cairn_core::{OpenFlags, Result, VfsBackend, VfsError, VfsPath};
    ...
    tracing_subscriber::fmt()
        .with_env_filter(
            tracing_subscriber::EnvFilter::try_from_default_env()
                .unwrap_or_else(|_| "cairn=info,info".into()),
        )
        .init();
