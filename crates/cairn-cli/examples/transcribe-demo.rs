...
#[command(
    ...
    about = "Cairn — M5 public API surface contract demo (does not yet transcribe)",
    long_about = "A no-op demonstration of the cairn-index trait surface. Today this \
...
async fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    println!("======================================================================");
    println!("  cairn transcribe-demo (v0.1.0-alpha.1, public API surface only)");
    println!("======================================================================");
    println!();
