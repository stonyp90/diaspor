//! # diaspor-backend-memory
//!
//! A simple in-memory implementation of [`diaspor_core::VfsBackend`]. Useful for tests,
...
//!
//! # async fn run() -> diaspor_core::Result<()> {
...
#![doc(html_root_url = "https://docs.rs/diaspor-backend-memory/0.1.0-alpha.1")]
