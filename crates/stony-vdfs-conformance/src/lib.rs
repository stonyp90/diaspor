//! # stony-vdfs-conformance
//!
//! A backend-agnostic conformance test suite. Every implementation of
//! [`stony_vdfs_core::VfsBackend`] must pass [`run`] in order to be considered compliant.
//!
...
//!     stony_vdfs_conformance::run(MemoryBackend::new()).await;
//! }
//! ```

#![doc(html_root_url = "https://docs.rs/stony-vdfs-conformance/0.1.0-alpha.1")]

use stony_vdfs_core::{NodeKind, OpenFlags, VfsBackend, VfsError, VfsPath};
