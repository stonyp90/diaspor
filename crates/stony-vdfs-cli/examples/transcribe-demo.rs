...
use bytes::Bytes;
use clap::Parser;
use stony_vdfs_core::{Result, VfsPath};
use stony_vdfs_index::{
...
#[command(
    ...
    about = "Stony VDFS — M5 public API surface contract demo (does not yet transcribe)",
    long_about = "A no-op demonstration of the stony-vdfs-index trait surface. Today this \
...
async fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    println!("======================================================================");
    println!("  stony-vdfs transcribe-demo (v0.1.0-alpha.1, public API surface only)");
    println!("======================================================================");
    println!();
