...
//! [`cairn_core::VfsBackend`] must pass [`run`] in order to be considered compliant.
//!
...
//!     cairn_conformance::run(MemoryBackend::new()).await;
//! }
//! ```

#![doc(html_root_url = "https://docs.rs/cairn-conformance/0.1.0-alpha.1")]

use cairn_core::{NodeKind, OpenFlags, VfsBackend, VfsError, VfsPath};
