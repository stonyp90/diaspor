//! # cairn-core
//!
//! Core traits and types for the Cairn (Virtual Distributed File System) library.
//!
...
//!
//! async fn list_root(backend: &dyn VfsBackend) -> cairn_core::Result<Vec<VfsPath>> {
//!     backend.list(&VfsPath::root()).await
//! }
//! ```

#![doc(html_root_url = "https://docs.rs/cairn-core/0.1.0-alpha.1")]
