//! # cairn-fuse
//!
//! FUSE mount adapter for [`cairn_core::VfsBackend`] implementations on Linux and
//! macOS.
//!
...
#![doc(html_root_url = "https://docs.rs/cairn-fuse/0.1.0-alpha.1")]
...
mod tests {
    ...
    use cairn_core::{OpenFlags, VfsHandle, VfsMetadata, VfsPath};
