//! # diaspor-core
//!
//! Core traits and types for the Diaspor (Virtual Distributed File System) library.
//!
...
//!
//! ```ignore
//! use diaspor_core::{VfsBackend, VfsPath};
//!
//! async fn list_root(backend: &dyn VfsBackend) -> diaspor_core::Result<Vec<VfsPath>> {
//!     backend.list(&VfsPath::root()).await
//! }
//! ```

#![doc(html_root_url = "https://docs.rs/diaspor-core/0.1.0-alpha.1")]
