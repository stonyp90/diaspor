//! # diaspor-index
//!
//! Content-aware indexing layer for `diaspor` backends.
//!
//! This crate adds *local-first* content understanding to any [`diaspor_core::VfsBackend`].
...
#![doc(html_root_url = "https://docs.rs/diaspor-index/0.1.0-alpha.1")]
...
///
/// In production: wrap an existing [`diaspor_core::VfsBackend`] so that every newly
