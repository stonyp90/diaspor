...
export const BUILTIN_PROVIDERS: StorageProviderDefinition[] = [
  ...
  // S3-Compatible (Generic - MinIO, Wasabi, etc.)
  {
    id: 's3-compatible',
    name: 'S3-Compatible Storage',
    category: 'cloud',
    icon: 'database',
    description: 'Generic S3-compatible storage (MinIO, Wasabi, etc.)',
    builtIn: true,
    configSchema: [
      {
        key: 'endpoint',
...
export type FileTierStatus = 'hot' | 'warm' | 'cold' | 'nearline';
...
export interface FileMetadata {
  ...
  /** Custom tags (user-defined) with optional colors */
 ...
 */
export type TierType = 'hot' | 'warm' | 'nearline' | 'cold';
