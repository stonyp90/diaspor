...
clear
print_header "Diaspor Installer"

echo -e "${BOLD}Welcome to the Diaspor installer!${NC}"
echo ""
echo "This installer will:"
echo "  1. Copy Diaspor to your Applications folder"
...
if [ -d "/Applications/$APP_NAME" ]; then
    print_warning "Diaspor is already installed in /Applications"
    echo ""
...
echo -e "${GREEN}${BOLD}Diaspor has been successfully installed!${NC}"
echo ""
echo "The app is now available in your Applications folder."
echo ""

# Ask to launch
echo -n "Would you like to launch Diaspor now? [Y/n] "
read -r launch_response
if [[ ! "$launch_response" =~ ^[Nn]$ ]]; then
    print_info "Launching Diaspor..."
    open "/Applications/$APP_NAME"
    print_success "Diaspor is starting!"
fi

echo ""
echo -e "${CYAN}Thank you for using Diaspor!${NC}"
echo "Visit https://diaspor.io for documentation and support."
echo ""
